...
class BookingFormModalViewController: UIViewController, UITextFieldDelegate {
...
extension BookingFormModalViewController {
    ...
    func constructCenterCustomView() {
        ...
        NSLayoutConstraint.activate([
            ...
            centerCustomView.heightAnchor.constraint(equalToConstant: 300),
    ...
    func constructFirstLabel() {
        ...
        NSLayoutConstraint.activate([
            firstLabel.topAnchor.constraint(equalTo: xmark.bottomAnchor, constant: 5),
