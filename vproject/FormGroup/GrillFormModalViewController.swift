...
class GrillFormModalViewController: UIViewController, UITextFieldDelegate {
...
extension GrillFormModalViewController {
    ...
    func constructDescriptionLabel() {
        descriptionLabel.text = "Our chef will teach you how to choose the right meat, marinate it properly, and achieve the perfect level of doneness. Cook steaks that will impress any gourmet!"
